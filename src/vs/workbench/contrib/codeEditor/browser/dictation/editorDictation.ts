...
export class DictationWidget extends Disposable implements IContentWidget {
	...
	beforeRender(): IDimension | null {
		...
		this.domNode.style.setProperty('--vsblocks-editor-dictation-widget-height', `${lineHeight}px`);
		this.domNode.style.setProperty('--vsblocks-editor-dictation-widget-width', `${width}px`);
