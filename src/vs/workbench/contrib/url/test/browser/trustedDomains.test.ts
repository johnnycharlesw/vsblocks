...
suite('Link protection domain matching', () => {
	...
	test('no scheme', () => {
		...
		// https://github.com/johnnycharlesw/vsblocks/issues/249353
	...
	test('case normalization', () => {
		// https://github.com/johnnycharlesw/vsblocks/issues/99294
		linkAllowedByRules('https://github.com/johnnycharlesw/vsblocks/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/johnnycharlesw/vsblocks/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/johnnycharlesw/vsblocks/issues/156839', () => {
