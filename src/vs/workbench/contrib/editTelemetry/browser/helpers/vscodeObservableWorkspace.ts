...
export class VSBlocksWorkspace extends ObservableWorkspace implements IDisposable {
	...
	constructor(
		...
		const documents = mapObservableArrayCached(this, models, (m, store) => {
			...
			return store.add(new VSBlocksDocument(m));
...
export class VSBlocksDocument extends Disposable implements IObservableDocument {
