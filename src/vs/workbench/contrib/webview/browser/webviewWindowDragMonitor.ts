...
/**
 * Allows webviews to monitor when an element in the VSBlocks editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. VSBlocks needs to see this
