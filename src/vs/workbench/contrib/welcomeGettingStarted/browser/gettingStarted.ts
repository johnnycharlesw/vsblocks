...
import { WorkspaceContextServiceInterface, UNKNOWN_EMPTY_WINDOW_WORKSPACE } from '../../../../platform/workspace/common/workspace.js';
import { IRecentFolder, IRecentWorkspace, IRecentlyOpened, WorkspaceInterfacesService, isRecentFolder, isRecentWorkspace } from '../../../../platform/workspaces/common/workspaces.js';
...
export class GettingStartedPage extends EditorPane {
	...
	private async runDispatchCommand(command: string, argument: string) {
		...
		switch (command) {
			...
			// Use selectTask over selectStep to keep telemetry consistant:https://github.com/johnnycharlesw/vsblocks/issues/122256
			case 'selectTask': {
	...
	private buildTelemetryFooter(parent: HTMLElement) {
		...
		const text = localize({ key: 'footer', comment: ['fist substitution is "VSBlocks", second is "privacy statement", third is "opt out".'] },
