 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in VSBlocks UI).
 */
 ...
 * to represent terminals that appear in other parts of the VSBlocks UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their VSBlocks OSC `SetMarker`
