...
/**
 * VSBlocks-specific shell integration sequences. Some of these are based on common alternatives like
 ...
 */
export const enum VSBlocksOscPt {
	/**
...
export const enum VSBlocksOscProperty {
	Task = 'Task',
	Cwd = 'Cwd'
}
...
export function VSBlocksSequence(osc: VSBlocksOscPt, data?: string | VSBlocksOscProperty): string {
	return oscSequence(ShellIntegrationOscPs.VSBlocks, osc, data);
}
