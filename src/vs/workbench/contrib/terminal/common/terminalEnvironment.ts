...
export async function createTerminalEnvironment(
	...
	if (shellLaunchConfig.strictEnv) {
		...
		// Workaround for https://github.com/johnnycharlesw/vsblocks/issues/204005
		...
		// Sanitize the environment, removing any undesirable VSBlocks and Electron environment
		// variables
