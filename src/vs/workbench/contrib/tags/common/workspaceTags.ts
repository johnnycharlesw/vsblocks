...
export const WorkspaceInterfaceTagsService = createDecorator<WorkspaceInterfaceTagsService>('workspaceTagsService');

export interface WorkspaceInterfaceTagsService {
	 ...
	 */
	getTelemetryWorkspaceId(workspace: WorkspaceInterface, state: WorkbenchState): Promise<string | undefined>;
