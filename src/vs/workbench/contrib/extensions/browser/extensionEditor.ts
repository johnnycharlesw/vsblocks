			...
			<head>
				...
				<style nonce="${nonce}">
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--vsblocks-button-secondaryBackground);
					...
					#scroll-to-top:hover {
						background-color: var(--vsblocks-button-secondaryHoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--vsblocks-button-secondaryForeground);
						/* Chevron up icon */
