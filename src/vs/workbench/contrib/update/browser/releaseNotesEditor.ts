			...
			<head>
				...
				<style nonce="${nonce}">
					...
					code:has(.codesetting) {
						background-color: var(--vsblocks-textPreformat-background);
						color: var(--vsblocks-textPreformat-foreground);
						padding-left: 1px;
						margin-right: 3px;
						padding-right: 0px;
					}
					...
					code:has(.codesetting):focus {
						border: 1px solid var(--vsblocks-button-border, transparent);
					}
					...
					.codesetting svg {
						...
						text-align: center;
						cursor: pointer;
						border: 1px solid var(--vsblocks-button-secondaryBorder, transparent);
					...
					.codesetting:hover {
						color: var(--vsblocks-textPreformat-foreground) !important;
					...
					.codesetting:focus {
						outline: 0 !important;
						text-decoration: none !important;
						color: var(--vsblocks-button-hoverForeground) !important;
					}
					.codesetting .separator {
						...
						margin-bottom: -3px;
						display: inline-block;
						background-color: var(--vsblocks-editor-background);
						font-size: 12px;
						margin-right: 4px;
					}
					...
					#scroll-to-top {
						...
						right: 25px;
						bottom: 25px;
						background-color: var(--vsblocks-button-background, #444);
						border-color: var(--vsblocks-button-border);
						border-radius: 50%;
						cursor: pointer;
					...
					#scroll-to-top:hover {
						background-color: var(--vsblocks-button-hoverBackground);
					...
					#scroll-to-top span.icon::before {
						content: "";
						display: block;
						background: var(--vsblocks-button-foreground);
						/* Chevron up icon */
					...
					#toc-nav a {
						color: var(--vsblocks-editor-foreground, #ccc);
						text-decoration: none !important;
					...
					#toc-nav a:hover {
						background-color: var(--vsblocks-button-secondaryHoverBackground, #1177bb);
						color: var(--vsblocks-button-secondaryForeground, #ffffff);
						cursor: pointer;
						text-decoration: none !important;
					}
