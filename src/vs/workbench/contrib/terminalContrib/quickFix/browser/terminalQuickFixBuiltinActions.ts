...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      https://github.com/johnnycharlesw/vsblocks/pull/new/my_branch
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on johnnycharlesw/vsblocks's default branch (...). To find out more, visit:
		// 5:  remote:      https://github.com/johnnycharlesw/vsblocks/security/dependabot
		// 4:  remote:
		// 3:  To https://github.com/johnnycharlesw/vsblocks
