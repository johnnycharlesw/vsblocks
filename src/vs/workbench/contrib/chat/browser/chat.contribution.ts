...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[ChatConfiguration.GlobalAutoApprove]: {
			default: false,
			// HACK: Description duplicated for policy parser. See https://github.com/johnnycharlesw/vsblocks/issues/254526
		...
		[mcpAccessConfig]: {
			...
			enumDescriptions: [
				...
				nls.localize('chat.mcp.access.registry', "Allows access to MCP servers installed from the registry that VSBlocks is connected to."),
