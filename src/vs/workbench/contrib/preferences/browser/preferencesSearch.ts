...
export class PreferencesSearchService extends Disposable implements IPreferencesSearchService {
	...
	// @ts-expect-error disable remote search for now, ref https://github.com/johnnycharlesw/vsblocks/issues/172411
...
export class LocalSearchProvider implements ISearchProvider {
	...
	searchModel(preferencesModel: ISettingsEditorModel, token: CancellationToken): Promise<ISearchResult | null> {
		...
		// Always allow description matches as part of https://github.com/johnnycharlesw/vsblocks/issues/239936.
