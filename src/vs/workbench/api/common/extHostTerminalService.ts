...
import { Disposable as VSBlocksDisposable, EnvironmentVariableMutatorType, TerminalExitReason, TerminalCompletionItem } from './extHostTypes.js';
...
class ExtHostPseudoterminal implements ITerminalChildProcess {
	...
	acknowledgeDataEvent(charCount: number): void {
		...
		// implemented it will need new pause and resume VSBlocks APIs.
	}
