...
export abstract class RequireInterceptor {
	...
	async install(): Promise<void> {
		...
		this.register(new VSBlocksNodeModuleFactory(this._apiFactory, extensionPaths, this._extensionRegistry, configProvider, this._logService));
...
class VSBlocksNodeModuleFactory implements INodeModuleFactory {
