...
suite('EditorService', () => {
	...
	test('openEditor() - same input does not cancel previous one - https://github.com/johnnycharlesw/vsblocks/issues/136684', async () => {
		const [, service] = await createEditorService();
	...
	test('side by side editor is not matching all other editors (https://github.com/johnnycharlesw/vsblocks/issues/132859)', async () => {
		const [part, service] = await createEditorService();
