...
export interface IConfigurationResolverService {
	...
	resolveWithEnvironment(environment: IProcessEnvironment, folder: WorkspaceInterfaceFolderData | undefined, value: string): Promise<string>;
	 ...
	 */
	resolveAsync<T>(folder: WorkspaceInterfaceFolderData | undefined, config: T): Promise<T extends ConfigurationResolverExpression<infer R> ? R : T>;
	 ...
	 */
	resolveWithInteractionReplace(folder: WorkspaceInterfaceFolderData | undefined, config: unknown, section?: string, variables?: IStringDictionary<string>, target?: ConfigurationTarget): Promise<any>;
	 ...
	 */
	resolveWithInteraction(folder: WorkspaceInterfaceFolderData | undefined, config: unknown, section?: string, variables?: IStringDictionary<string>, target?: ConfigurationTarget): Promise<Map<string, string> | undefined>;
