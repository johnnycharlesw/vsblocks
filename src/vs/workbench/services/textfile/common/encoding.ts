...
// - UTF-32: we do not support this encoding in VSBlocks
...
async function guessEncodingByBuffer(buffer: VSBuffer, candidateGuessEncodings?: string[]): Promise<string | null> {
	...
	try {
		...
		return null; // jschardet throws for unknown encodings (https://github.com/johnnycharlesw/vsblocks/issues/239928)
	}
