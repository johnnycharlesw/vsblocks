...
class LocalStorageURLCallbackProvider extends Disposable implements IURLCallbackProvider {
	...
	create(options: Partial<UriComponents> = {}): URI {
		...
		// https://github.com/johnnycharlesw/vsblocks-dev/issues/62
		// https://github.com/johnnycharlesw/vsblocks/blob/159479eb5ae451a66b5dac3c12d564f32f454796/extensions/github-authentication/src/githubServer.ts#L50-L50
