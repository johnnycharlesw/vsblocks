...
export class RemoteAgentFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel<RemoteAgentConnectionContext> {
	...
	protected override transformIncoming(uriTransformer: IURITransformer, _resource: UriComponents, supportVSBlocksResource = false): URI {
		if (supportVSBlocksResource && _resource.path === '/vscode-resource' && _resource.query) {
