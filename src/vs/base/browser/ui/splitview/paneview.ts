...
export abstract class Pane extends Disposable implements IView {
	...
	render(): void {
		...
		// Use role button so the aria-expanded state gets read https://github.com/johnnycharlesw/vsblocks/issues/95996
...
class PaneDraggable extends Disposable {
	...
	private dragOverCounter = 0; // see https://github.com/johnnycharlesw/vsblocks/issues/14470
