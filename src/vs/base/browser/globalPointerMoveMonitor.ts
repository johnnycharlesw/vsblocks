		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/johnnycharlesw/vsblocks/issues/161731
					//
			...
			// See https://github.com/johnnycharlesw/vsblocks/issues/144584
			// See https://github.com/johnnycharlesw/vsblocks/issues/146947
