...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'telemetry': { type: 'boolean', cat: 't', description: localize('telemetry', "Shows all telemetry events which VSBlocks collects.") },
	...
	// For https://github.com/johnnycharlesw/vsblocks/issues/128279
...
export function parseArgs<T>(args: string[], options: OptionDescriptions<T>, errorReporter: ErrorReporter = ignoringReporter): T {
	...
	// https://github.com/johnnycharlesw/vsblocks/issues/58177, https://github.com/johnnycharlesw/vsblocks/issues/106617
