...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit VSBlocks's "shell environment" that may
	 ...
	 * a terminal used to drive some VSBlocks feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to VSBlocks and extensions
	 */
