...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/johnnycharlesw/vsblocks.git'), allowedDomains), ['github.com']);
	...
	test('SCP-like remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('git@github.com:johnnycharlesw/vsblocks.git'), allowedDomains), ['github.com']);
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/johnnycharlesw/vsblocks.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/johnnycharlesw/vsblocks.git')), ['github.com/johnnycharlesw/vsblocks.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/johnnycharlesw/vsblocks.git'), true), ['github.com/johnnycharlesw/vsblocks']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/johnnycharlesw/vsblocks.git'), true), getRemotes(remote('https://github.com/johnnycharlesw/vsblocks')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:johnnycharlesw/vsblocks.git')), ['github.com/johnnycharlesw/vsblocks.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:johnnycharlesw/vsblocks.git'), true), ['github.com/johnnycharlesw/vsblocks']);
		...
		// Compare Striped .git with no .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:johnnycharlesw/vsblocks.git'), true), getRemotes(remote('git@github.com:johnnycharlesw/vsblocks')));
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/johnnycharlesw/vsblocks.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/johnnycharlesw/vsblocks.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/johnnycharlesw/vsblocks', 'git.example.com/gitproject']);
