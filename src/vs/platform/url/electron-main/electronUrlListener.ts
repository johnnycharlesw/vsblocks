...
/**
 * A listener for URLs that are opened from the OS and handled by VSBlocks.
 * Depending on the platform, this works differently:
 * - Windows: we use `app.setAsDefaultProtocolClient()` to register VSBlocks with the OS
 ...
 *            that calls VSBlocks with the `open-url` command line argument
 *            (https://github.com/johnnycharlesw/vsblocks/pull/56727)
 */
