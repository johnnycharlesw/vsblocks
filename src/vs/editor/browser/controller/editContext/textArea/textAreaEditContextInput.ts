...
export class TextAreaInput extends Disposable {
	...
	constructor(
		...
		this._register(this._textArea.onBlur(() => {
			if (this._currentComposition) {
				// See https://github.com/johnnycharlesw/vsblocks/issues/112621
	...
	private _installSelectionChangeListener(): IDisposable {
		// See https://github.com/johnnycharlesw/vsblocks/issues/27216 and https://github.com/johnnycharlesw/vsblocks/issues/98256
