...
export class ParameterHintsWidget extends Disposable implements IContentWidget {
	...
	private createParameterHintDOMNodes() {
		...
		const updateFont = () => {
			...
			element.style.setProperty('--vsblocks-parameterHintsWidget-editorFontFamily', fontInfo.fontFamily);
			element.style.setProperty('--vsblocks-parameterHintsWidget-editorFontFamilyDefault', EDITOR_FONT_DEFAULTS.fontFamily);
		};
