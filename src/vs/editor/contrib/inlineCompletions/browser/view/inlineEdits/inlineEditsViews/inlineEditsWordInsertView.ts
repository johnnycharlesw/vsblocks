				...
				return [
					n.div({
						style: {
							...
							borderRadius: '4px',
							background: 'var(--vsblocks-editor-background)'
						}
					}, []),
					n.div({
						style: {
							...
							padding: '0px',
							textAlign: 'center',
							background: 'var(--vsblocks-inlineEdit-modifiedChangedTextBackground)',
					...
					n.div({
						style: {
							...
							background: 'var(--vsblocks-inlineEdit-wordReplacementView-background)',
						}
					}, []),
					n.svg({
						viewBox: '0 0 12 18',
						...
						n.svgElem('path', {
							...
							fill: 'var(--vsblocks-inlineEdit-modifiedChangedTextBackground)',
						})
					])
				];
			})
