...
declare module 'vsblocks' {
	...
	// https://github.com/johnnycharlesw/vsblocks/issues/59921
	 ...
	 * TODO@roblourens merge this with the GlobPattern docs/definition in vsblocks.d.ts.
	...
	export interface SearchOptions {
		 ...
		 * See the vsblocks setting `"search.useIgnoreFiles"`.
		 */
		useIgnoreFiles: boolean;

		/**
		 * Whether symlinks should be followed while searching.
		 * See the vsblocks setting `"search.followSymlinks"`.
		 */
		followSymlinks: boolean;

		/**
		 * Whether global files that exclude files, like .gitignore, should be respected.
		 * See the vsblocks setting `"search.useGlobalIgnoreFiles"`.
		 */
		useGlobalIgnoreFiles: boolean;

		/**
		 * Whether files in parent directories that exclude files, like .gitignore, should be respected.
		 * See the vsblocks setting `"search.useParentIgnoreFiles"`.
		 */
	...
	export interface TextSearchOptions extends SearchOptions {
		 ...
		 * See the vsblocks setting `"files.encoding"`
		 */
		encoding?: string;
