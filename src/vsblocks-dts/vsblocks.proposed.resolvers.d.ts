...
declare module 'vsblocks' {
	...
	export interface RemoteAuthorityResolver {
		/**
		 * Resolve the authority part of the current opened `vsblocks-remote://` URI.
		 *
		 * This method will be invoked once during the startup of the editor and again each time
		 * the editor detects a disconnection.
		 *
		 * @param authority The authority part of the current opened `vsblocks-remote://` URI.
		...
		/**
		 * Get the canonical URI (if applicable) for a `vsblocks-remote://` URI.
		 *
	...
	export interface ResourceLabelFormatting {
		...
		// eslint-disable-next-line local/vsblocks-dts-literal-or-types, local/vsblocks-dts-string-type-literals
		separator: '/' | '\\' | '';
		tildify?: boolean;
	...
	export namespace env {
		...
		/**
		 * The authority part of the current opened `vsblocks-remote://` URI.
