...
if (process.platform === 'win32') {
	if (!hasSupportedVisualStudioVersion()) {
		console.error('\x1b[1;31m*** Invalid C/C++ Compiler Toolchain. Please check https://github.com/johnnycharlesw/vsblocks/wiki/How-to-Contribute#prerequisites.\x1b[0;0m');
...
if (process.arch !== os.arch()) {
	...
	console.error(`\x1b[1;31m*** This can greatly increase the build time of VSBlocks. ***\x1b[0;0m`);
}
