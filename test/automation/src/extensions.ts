...
export class Extensions extends Viewlet {
	...
	async searchForExtension(id: string): Promise<any> {
		...
		await this.code.waitForTypeInEditor(`div.extensions-viewlet[id="workbench.view.extensions"] .vsblockengine ${!this.code.editContextEnabled ? 'textarea' : '.native-edit-context'}`, `@id:${id}`);
