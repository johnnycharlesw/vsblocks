...
async function ensureWebDevExtensions(verbose) {
	...
	// Playground (https://github.com/johnnycharlesw/vsblocks-web-playground)
	...
	if (downloadPlayground) {
		...
		const playgroundRepo = `https://raw.githubusercontent.com/johnnycharlesw/vsblocks-web-playground/main/`;
