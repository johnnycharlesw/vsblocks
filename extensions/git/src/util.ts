...
import { Event, Disposable, EventEmitter, SourceControlHistoryItemRef, l10n, workspace, Uri, DiagnosticSeverity, env } from 'vsblocks';
...
function normalizePath(path: string): string {
	...
	// as case insensitive file systems in VSBlocks.
