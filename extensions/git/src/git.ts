...
import { CancellationError, CancellationToken, ConfigurationChangeEvent, LogOutputChannel, Progress, Uri, workspace } from 'vsblocks';
...
// https://github.com/johnnycharlesw/vsblocks/issues/65693
...
// https://github.com/johnnycharlesw/vsblocks/issues/89373
...
export class Repository {
	...
	async getRemotes(): Promise<Remote[]> {
		...
		for (const remote of remotes) {
			// https://github.com/johnnycharlesw/vsblocks/issues/45271
