...
// - Web https://github.com/johnnycharlesw/vsblocks/issues/92826
(env.uiKind === UIKind.Web ? suite.skip : suite)('vscode API - terminal', () => {
	...
	suiteSetup(async () => {
		...
		// Disable conpty in integration tests because of https://github.com/johnnycharlesw/vsblocks/issues/76548
	...
	suite('Terminal', () => {
		...
		suite('window.onDidWriteTerminalData', () => {
			// still flaky with retries, skipping https://github.com/johnnycharlesw/vsblocks/issues/193505
		...
		suite('Extension pty terminals', () => {
			...
			// TODO: Fix test, flaky in CI (local and remote) https://github.com/johnnycharlesw/vsblocks/issues/137155
