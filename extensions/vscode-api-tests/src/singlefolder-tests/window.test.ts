...
suite('vscode API - window', () => {
	...
	// TODO@lramos15 https://github.com/johnnycharlesw/vsblocks/issues/145846
	...
	*/
	...
	test('showQuickPick, keep selection (johnnycharlesw/vsblocks-azure-account#67)', async function () {
