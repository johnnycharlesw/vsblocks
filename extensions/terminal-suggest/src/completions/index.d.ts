...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- VSBlocks edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- VSBlocks edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- VSBlocks edit to make results correct
		/**
		 *
