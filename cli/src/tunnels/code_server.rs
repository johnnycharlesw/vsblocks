...
/// Server params that can be used to start a VSBlocks server.
...
impl<'a> ServerBuilder<'a> {
	...
	async fn spawn_server_process(&self, mut cmd: Command) -> Result<Child, AnyError> {
		...
		// only on Windows.
		// Original issue: https://github.com/johnnycharlesw/vsblocks/issues/184058
		// Partial fix: https://github.com/johnnycharlesw/vsblocks/pull/184621
...
/// A type that can be used to scan stdout from the VSBlocks server. Returns
